<template>
    <div class="flex-container" v-if="isMounted">
        <div class="sidebar">
            <div class="categories">
                <router-link :to="{name: 'showMatrices'}" :class="{'active' : this.$route.path.includes('matrices') || this.$route.path.includes('matrix')}">
                ...
                <router-link :to="{name: 'showCadastralParcels'}" :class="{'active' : this.$route.path.includes('cadastral-parcels')}">
                    <svg style="width:20px;height:20px" viewBox="0 0 24 24">
                ...
                <router-link :to="{name: 'showCultures'}" :class="{'active' : this.$route.path.includes('cultures')}" v-if="checkRole()">
                    <svg style="width:20px;height:20px" viewBox="0 0 24 24">
                ...
                <router-link :to="{name: 'showReports'}" :class="{'active' : this.$route.path.includes('reports')}">
                    <svg style="width:20px;height:20px" viewBox="0 0 24 24">
