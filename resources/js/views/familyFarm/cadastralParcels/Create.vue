<template>
    <modal title="Dodavanje katastarske čestice" ref="modal" size="m">
        <form method="post" @submit.prevent="createCadastralParcel">
...
export default {
    ...
    methods: {
        createCadastralParcel(){
            this.loading = true;
            axios.post("/family-farm/create-cadastral-parcel", this.formData).then((response) => {
